...
export const metadata: Metadata = {
  ...
  description: "Terms for using the free Padel Tourni service.",
};
  ...
  return (
    <LegalDocument title="Terms of Service">
      ...
      <LegalSection title="1. About these terms">
        <p>
          These Terms of Service govern your use of Padel Tourni, a privately
          operated, free recreational service for organizing padel events. By
          using Padel Tourni, you agree to these terms and to use the service
          lawfully and respectfully.
        </p>
        <p>
          Padel Tourni does not currently offer subscriptions, paid features,
      ...
      <LegalSection title="2. Accounts and Google sign-in">
        <p>
          ...
          account secure. Padel Tourni does not receive your Google password.
        </p>
        <p>
      ...
      <LegalSection title="4. Tournament information">
        <p>
          Padel Tourni helps organize draws, timers, scores, standings, and
      ...
      <LegalSection title="5. Acceptable use">
        <p>You must not use Padel Tourni to:</p>
      ...
      <LegalSection title="8. Ownership and feedback">
        <p>
          Padel Tourni, its branding, and its original interface and content
        ...
        <p>
          ...
          other people whose information you enter. You allow Padel Tourni to
      ...
      <LegalSection title="9. Liability">
        <p>
          ...
          permitted by applicable law. Subject to that limitation, Padel Tourni
